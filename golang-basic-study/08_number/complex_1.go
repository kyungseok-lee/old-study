...
func main() {
	...
	fmt.Println(num1) // (1+2i)
	fmt.Println(num2) // (4.2342+2.3527i)
	fmt.Println(num3) // (0+1000i)
	fmt.Println(num4) // (0+7.27151e-10i)
	fmt.Println(num5) // (1+2i)
	fmt.Println(num6) // (5.32521e-10+12.345i)
